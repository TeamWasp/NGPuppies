...
START TRANSACTION;
USE `ngpuppies`;
INSERT INTO `ngpuppies`.`clients` (`ClientID`, `Username`, `Password`, `RoleID`, `EIK`, `EmailAddress`) VALUES (1, 'unicredit_bulbank', 'unicredit_bulbank', 2, '9999999999', 'unicredit_bulbank@unicreditgroup.bg');
INSERT INTO `ngpuppies`.`clients` (`ClientID`, `Username`, `Password`, `RoleID`, `EIK`, `EmailAddress`) VALUES (2, 'dsk_bank', 'dsk_bank', 2, '0000000000', 'dsk_bank@dskbank.bg');
...
INSERT INTO `ngpuppies`.`clients` (`ClientID`, `Username`, `Password`, `RoleID`, `EIK`, `EmailAddress`) VALUES (5, 'united_bulgarian_bank', 'united_bulgarian_bank', 2, '3333333333', 'ubb@ubb.bg');
